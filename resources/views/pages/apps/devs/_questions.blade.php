    ...
    @foreach ($questions as $question)
        ...
        <div class="mb-0">
            ...
            <div class="d-flex align-items-center mb-4">
                <!--begin::Title-->
                <a href="{{ theme()->getPageUrl('apps/devs/question') }}"
            ...
            <div class="d-flex flex-stack flex-wrap">
                ...
                <div class="d-flex align-items-center py-1">
                    <!--begin::Answers-->
                    <a href="{{ theme()->getPageUrl('apps/devs/question') }}#answers"
                    ...
                    <!--begin::Upvote-->
                    <a href="#"
                        class="btn btn-sm btn-flex btn-light {{ empty($question['upvotes']) ? 'btn-icon' : 'px-3' }}"
                        data-bs-toggle="tooltip" title="Upvote this question" data-bs-dismiss="click">
                        {{ $question['upvotes'] }}
                        {!! theme()->getSvgIcon(
                            'icons/duotune/arrows/arr062.svg',
                            'svg-icon-7' . (empty($question['upvotes']) ? '' : 'ms-2 me-0'),
                        ) !!}
                    </a>
                    <!--end::Upvote-->
                </div>
...
<div class="d-flex flex-center mb-0">
    @foreach ($pagination as $page)
        ...
        @else
            <a href="#"
                class="btn btn-icon btn-light btn-active-light-primary h-30px w-30px fw-bold fs-6 mx-2 {{ $page == '2' ? 'active' : '' }}">{{ $page }}</a>
        @endif
    @endforeach
</div>
<!--end::Questions-->
